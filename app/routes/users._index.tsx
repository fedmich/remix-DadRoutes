...
export let loader: LoaderFunction = async () => {
  ...
  const queryText = 'SELECT * FROM users WHERE active = TRUE ORDER BY num_routes < 1, id = 1 , followers desc, following desc LIMIT 25';
    ...
    <Layout>
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {users.map((user) => (
            <div key={user.id} className="bg-white border rounded-lg p-4 shadow-md flex flex-col items-center text-center">
